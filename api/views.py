...
class BookReviewAPIView(APIView):
    ...
    def delete(self, request, id):
        ...
        book_review.delete()
        data = {
            "message": "You have successfully deleted this review",
        }
...
class BookReviewListAPIVIew(APIView):
    ...
    def get(self, request):
        ...
        page_oj = paginator.paginate_queryset(book_reviews, request)
        serializer = BookReviewSerializer(page_oj, many=True)
    ...
    def post(self, request):
        ...
        data = {
            "message": "You have successfully created a review for this book!"
        }
        if serializer.is_valid():
            serializer.save()
